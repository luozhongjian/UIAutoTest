...
def do_action(): 
    ...
    #审核
    examinerep = License(driver, testDataDic)
    examineRes = examinerep.license_examine()
    if examineRes:
        reporter.reportEvent("Passed", u"许可证审核", u"审核流程成功！")
    else:
        reporter.reportEvent("Failed", u"许可证审核", u"审核流程失败！")
