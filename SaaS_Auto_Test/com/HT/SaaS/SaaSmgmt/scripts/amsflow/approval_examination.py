...
def do_action(): 
    ...
    #审批
    examinationrep = approval(driver, testDataDic)
    examinationRes = examinationrep.examination()
    if examinationRes:
        reporter.reportEvent("Passed", u"建设项目审批", u"审批流程成功！")
    else:
        reporter.reportEvent("Failed", u"建设项目审批", u"审批流程失败！")
