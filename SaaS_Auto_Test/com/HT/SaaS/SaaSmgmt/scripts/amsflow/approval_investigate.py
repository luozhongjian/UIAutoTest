...
def do_action(): 
    ...
    #审查
    investigaterep = approval(driver, testDataDic)
    investigateRes = investigaterep.investigate()
    if investigateRes:
        reporter.reportEvent("Passed", u"建设项目审查", u"审查流程成功！")
    else:
        reporter.reportEvent("Failed", u"建设项目审查", u"审查流程失败！")
